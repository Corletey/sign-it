...
// resolve image link later
  return (
    <div
      className="relative flex items-center justify-center h-60 bg-fixed bg-center bg-cover"
      style={{ backgroundImage: `url(${backgroundImage})` }}
    >
      <div className="absolute inset-0 bg-black opacity-60"></div> {/* Dark overlay */}
      <div className="relative z-10 text-center p-4">
        <h1 className="text-2xl md:text-4xl font-bold text-white">My Dashboard</h1>
